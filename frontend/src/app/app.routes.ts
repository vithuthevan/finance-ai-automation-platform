...
export const routes: Routes = [
  ...
  { path: 'unauthorized', loadComponent: () => import('./features/auth/unauthorized.page').then(m => m.UnauthorizedPage) },
  {
    ...
    children: [
      ...
      { path: 'clients/monthly-evidence', canActivate: [roleGuard('ADMIN', 'ACCOUNTANT')], loadComponent: () => import('./features/clients/monthly-evidence.page').then(m => m.MonthlyEvidencePage) },
      ...
      { path: 'ar', canActivate: [roleGuard('ADMIN', 'ACCOUNTANT', 'AUDITOR')], loadComponent: () => import('./features/ar/ar.page').then(m => m.ArPage) },
      { path: 'ar/payments/:paymentId', canActivate: [roleGuard('ADMIN', 'ACCOUNTANT', 'AUDITOR')], loadComponent: () => import('./features/ar/ar-payment-detail.page').then(m => m.ArPaymentDetailPage) },
      { path: 'client-chase', canActivate: [roleGuard('ADMIN', 'ACCOUNTANT')], loadComponent: () => import('./features/chase/client-chase.page').then(m => m.ClientChasePage) },
