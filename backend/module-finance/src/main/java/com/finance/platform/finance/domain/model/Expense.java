...
public class Expense extends TenantAwareEntity {
	...
	public void approve(User approver) {
		if (status != TransactionStatus.DRAFT) {
			throw new IllegalStateException("Only DRAFT expenses can be approved");
		}
	...
	public void voidExpense(User voidedBy, String reason) {
		if (status != TransactionStatus.APPROVED) {
			throw new IllegalStateException("Only APPROVED expenses can be voided");
		}
